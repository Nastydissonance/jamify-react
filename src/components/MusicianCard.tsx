...
const MusicianCard = React.memo(({ musician }: MusicianCardProps) => {
  ...
  const handleEdit = async (updatedData: Omit<Musician, 'id'>) => {
    try {
      await api.put(`/musicians/${musician.id}`, {
        ...updatedData,
        id: musician.id,
      });
    ...
    <>
      ...
      >
        ...
        <p className="musician-description">
          ...
          {musician.description && musician.description.length > 80 ? '...' : ''}
        </p>
      ...
      <Modal
        ...
        title={
          <>
            <i className="fas fa-user-edit"></i> EDIT MUSICIAN
          </>
        }
      >
        <MusicianForm
      ...
      <Modal
        ...
        title={
          <>
            <i className="fas fa-user-minus"></i> DELETE MUSICIAN
          </>
        }
      >
